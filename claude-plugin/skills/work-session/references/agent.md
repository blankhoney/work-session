...
- Temporary execution units provide retrieval, construction, bounded audit, simplification, tests, and non-mechanical summaries. They are not a persistent third role. Leader may mechanically summarize bounded results.
- The host harness owns model, effort, execution-unit identity/type, tools, concurrency, and dispatch. Local templates are optional and their absence never blocks Work Session.
